...
function TeacherForm() {
    ...
    return (
        <div id="page-teacher-form" className="container">
            <PageHeader title="Que legal que você quer dar aula" description="O priumeiro passo é preencher esse formulário de inscrição"/>
            ...
            <main>
                <form onSubmit={handleCreateClass}>
                    ...
                    <fieldset>
                        ...
                        <Input name="cost" label="Custo hora por aula" value={cost} onChange={(e) => { setCost(e.target.value)} }/>
                    </fieldset>
